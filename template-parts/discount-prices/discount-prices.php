                ...
                <a class="nav-link ico-button pe-0 py-0" href="viber://chat?number=79299262301"><img
                    src="<?php echo get_template_directory_uri(); ?>/img/ico/viber-ico.png"></a>
						...
						<div class="d-flex align-items-start prices-section-responsive-phone">
							<img decoding="async" src="<?php echo get_template_directory_uri(); ?>/img/ico/mobile-phone-ico.svg" alt="Телефон" class="me-2 img-fluid" aria-hidden="true">
							<a href="tel:+79299262301" class="text-decoration-none text-dark">8 <span>(929)</span> 926-23-01 </a>
						</div>

						<button data-bs-toggle="modal" data-bs-target="#callbackModal" type="button" class="btn btn-lg btn-corporate-color-1 prices-section-responsive-btn">Перезвонить</button>
