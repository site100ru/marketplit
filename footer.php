					...
					<div class="col-md-12 pt-2 pb-4">
						<nav id="contacts-menu-1" class="navbar-light">
							...
							<div class="row h-100 justify-content-center align-items-center d-none d-lg-flex">
								<div class="col-3">
									<a href="#">
										<img id="navbar-brand-img" src="<?php echo get_template_directory_uri(); ?>/img/ico/logo-light.png" class="img-fluid">
									</a>
								</div>
								<div class="col-5">
							...
							<div class="row d-lg-none">
								...
								<div class="col-12">
									<ul class="nav mb-2">
										<li class="nav-item d-inline-block">
											<a href="/контакты" class="nav-link ps-0">
												<img src="<?php echo get_template_directory_uri(); ?>/img/ico/location-ico.png">
												<span>г. Химки, Вашутинское ш., вл. 1, корп. 10</span>
											</a>
										</li>
										<li class="nav-item d-inline-block">
											<a href="mailto:1752800@mail.ru" class="nav-link ps-0">
												<img src="<?php echo get_template_directory_uri(); ?>/img/ico/email-ico.png">
												<span>1752800@mail.ru</span>
											</a>
										</li>
						...
						<nav id="contacts-menu-2" class="navbar navbar-expand-xl navbar-light mb-3">
							<div class="collapse navbar-collapse">
								<ul class="navbar-nav m-auto mb-2 mb-lg-0">
									...
									<li class="nav-item">
										<a class="nav-link" href="/product-category/мдф-без-покрытия">МДФ без покрытия</a>
									</li>
									<li class="nav-item d-none d-xxl-inline">
										<span class="nav-link px-2"><img src="<?php echo get_template_directory_uri(); ?>/img/ico/menu-point.png"></span>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="/product-category/мдф-с-покрытием">МДФ с покрытием</a>
									</li>
									<li class="nav-item d-none d-xxl-inline">
										<span class="nav-link px-2"><img src="<?php echo get_template_directory_uri(); ?>/img/ico/menu-point.png"></span>
									</li>
									<li class="nav-item">
										<a class="nav-link" href="/распил">Распил</a>
									</li>
									<li class="nav-item d-none d-xxl-inline">
										<span class="nav-link px-2"><img src="<?php echo get_template_directory_uri(); ?>/img/ico/menu-point.png"></span>
									</li>
									...
									<li class="nav-item d-xl-none mb-2">
										<a class="ico-button pe-1" href="whatsapp://send?phone=+79299262301" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/ico/whatsapp-ico.png"></a>
										<a class="ico-button pe-1" href="tg://resolve?domain=NikolaevAA2023" target="_blank"><img src="<?php echo get_template_directory_uri(); ?>/img/ico/telegram-ico.png"></a>
						...
						<div class="row d-lg-none justify-content-center">
							<div class="col-6 left-col-footer-menu">
								<ul id="menu-main-menu-2" class="navbar-nav ms-auto mb-lg-0">
									...
									<li class="nav-item"><a href="/product-category/мдф-без-покрытия" class="nav-link">МДФ без покрытия</a></li>
									<li class="nav-item"><a href="/product-category/мдф-с-покрытием" class="nav-link">МДФ с покрытием</a></li>
								</ul>
							</div>
			...
			<div class="modal-dialog modal-dialog-centered">
				<form method="post" action="<?php echo get_template_directory_uri(); ?>/mails/callback-mail.php" class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title text-corporate-color-1" id="callbackModalLabel">Обратный звонок</h5>
					...
					<div class="modal-footer">
						<button type="submit" class="btn btn-corporate-color-1 mx-auto pt-2">Перезвонить</button>
					</div>
				</form>
			</div>
		</div>
				...
				<form method="post" action="callback-mail.php" class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="row">
							<div class="col-6">
								<p class="mb-0">
									<img src="<?php echo get_template_directory_uri(); ?>/img/ico/advantage-1.png" class="me-1" style="width: 25px;">
									<small>Изготовление 2-5 дней!</small>
								</p>
							</div>
							<div class="col-6">
								<p class="mb-0">
									<img src="<?php echo get_template_directory_uri(); ?>/img/ico/advantage-3.png" class="me-1" style="width: 20px;">
		...
		<script type="text/javascript">
			...
			function init() {
				...
				var myMap = new ymaps.Map("map", {
					...
					center: [55.923019,37.403082], // Map center
					// Уровень масштабирования. Допустимые значения:
					// от 0 (весь мир) до 19.
					zoom: zoom
				});
				var myPlacemark = new ymaps.Placemark( [55.923019,37.403082], {}, {
